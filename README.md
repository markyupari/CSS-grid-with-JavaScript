...
## Applying grid style using JavaScript

This page shows how to start styling using CSS grid and JavaScript with a function that applies style to div elements one by one sequentially. 
